<template>
  <div id="app">
	...
	<div class="footer_guide">
		...
		<a class="guide_item">
			<span class="item_icon">
				<router-link to='/User' class="iconfont">我的视频</router-link>
			</span>
		</a>
		<a class="guide_item" v-if="isAdmin">
			<span class="item_icon">
				<router-link to='/Admin' class="iconfont">后台管理</router-link>
			</span>
		</a>
	</div>
	<!-- v-on:事件标签="函数名" -->
	<router-view style="height:auto;margin-bottom: 7.5rem;overflow-y: hidden;" v-on:setRouterPointer="routerPointer"></router-view>
  </div>
</template>
